...
######################################################################
def get_halo_data_interpolation(Qx, Qy, cs_grid):
    N   = cs_grid.N
    ng  = cs_grid.nghost
...
######################################################################
# This routine get the halo data of Qx needed for interpolation
...
def get_halo_data_interpolation_WE(Qx, Qy, cs_grid):
    ...
    # Data of panel 0 from east
    halodata_east[:,:,p] = Qx[i0:i0+ngr,j0:jend,east] # Panel 1

    # Data of panel 0 from  west
    halodata_west[:,:,p] = Qx[iend-ngl:iend,j0:jend, west] # Panel 3
    ...
    # Data of panel 1 from east
    halodata_east[:,:,p] = Qx[i0:i0+ngr,j0:jend,east] # Panel 2

    # Data of panel 1 from west
    halodata_west[:,:,p] = Qx[iend-ngl:iend,j0:jend, west] # Panel 0
    ...
    # Data of panel 2 from east
    halodata_east[:,:,p] = Qx[i0:i0+ngr,j0:jend,east] # Panel 3

    # Data of panel 2 from west
    halodata_west[:,:,p] = Qx[iend-ngl:iend,j0:jend, west] # Panel 1
    ...
    # Data of panel 3 from east
    halodata_east[:,:,p] = Qx[i0:i0+ngr,j0:jend,east] # Panel 0

    # Data of panel 3 from west
    halodata_west[:,:,p] = Qx[iend-ngl:iend,j0:jend, west] # Panel 2
    ...
    # Data of panel 4 from east
    support_values = Qy[i0:iend,jend-ngl:jend,east] # Panel 3
    support_values = np.flip(support_values,axis=1)
    support_values = np.transpose(support_values)
    halodata_east[:,:,p] = support_values

    # Data of panel 4 from west
    support_values = Qy[i0:iend,jend-ngl:jend, west] # Panel 1
    support_values = np.transpose(support_values)
    support_values = np.flip(support_values,axis=1)
    halodata_west[:,:,p] = support_values
    ...
    # Data of panel 5 from east
    support_values = Qy[i0:iend,j0:j0+ngr,east] # Panel 1
    support_values = np.transpose(support_values)
    support_values = np.flip(support_values,axis=1)
    halodata_east[:,:,p] = support_values

    # Data of panel 5 from west
    support_values = Qy[i0:iend,j0:j0+ngr, west] # Panel 3
    support_values = np.transpose(support_values)
    support_values = np.flip(support_values,axis=0)
    halodata_west[:,:,p] = support_values
