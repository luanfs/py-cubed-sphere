...
def adv_time_step(cs_grid, simulation, g_metric, Q_old, Q_new, k, dt, t, ax, ay, cx, cx2, cy, cy2, \
                  ...
                  F_gQ, G_gQ, GF_gQ, FG_gQ, transformation, interpol_method,\
    ...
    ghost_cells_lagrange_interpolation(Q_old, cs_grid, transformation, simulation, interpol_method, lagrange_poly, lagrange_poly_flipped, Kmin, Kmax)
